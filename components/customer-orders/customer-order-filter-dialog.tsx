...
interface CustomerOrderFilterDialogProps {
  open: boolean
...
export function CustomerOrderFilterDialog({
  open,
  onOpenChange,
  statusFilter,
  paymentStatusFilter,
  ...
  onReset,
  onApply,
}: CustomerOrderFilterDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Filter Customer Orders</DialogTitle>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              aria-label="Show archived customer orders"
            />
