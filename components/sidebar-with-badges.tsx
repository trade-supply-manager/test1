...
type SidebarProps = {
  pendingStorefrontOrdersCount: number
  deliveryConflictsCount: number
  lowStockCount: number
}

export function SidebarWithBadges({
  pendingStorefrontOrdersCount,
  deliveryConflictsCount,
  lowStockCount,
}: SidebarProps) {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          badge: pendingStorefrontOrdersCount,
        },
        {
              ...
              <div key={group.title} className="space-y-1">
                ...
                {group.items.map((item) => (
                  ...
                  >
                    ...
                    {"badge" in item && <NavBadge count={item.badge || 0} collapsed={collapsed} />}
                  </Link>
                ))}
              </div>
            )
