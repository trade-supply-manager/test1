...
export function TopProducts({ orderItemsData }: TopProductsProps) {
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Top 10 products by sales value</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    data={
                      ...
                      Array.from(
                        productData.reduce((acc, product) => {
                          ...
                          const current = acc.get(category) || { name: category, value: 0 }
                          acc.set(category, {
                            name: category,
                            value: current.value + product.value,
                          })
                          return acc
                        }, new Map()),
                      ).map(([_, value]) => value)
